class Solution:
    def shortestBridge(self, grid: List[List[int]]) -> int:
         # consider 0's and 1's as nodes of graph and then we 
         # can treverse the nodes with min distince or vistting
         # minimum node
            
        # ref from https://leetcode.com/problems/shortest-bridge/discuss/3546471/Python3-Solution
